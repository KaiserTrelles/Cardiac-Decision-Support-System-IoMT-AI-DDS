...
if __name__ == '__main__':
    ...
    data_dir = r'C:\Users\Usuario\Desktop\A Real-Time Cardiac Decision Support System for Internet of Medical Things Using Edge AI and DDS\Datasets\Adult Dataset'
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val':
                if epoch_acc > best_val_acc:
                    ...
                    torch.save(model.state_dict(), 'ecg_mobilenet_BEST_adult.pth')
        ...
        torch.save(history, 'training_history_adult.pth')
    ...
    print("History saved to training_history_adult.pth")
