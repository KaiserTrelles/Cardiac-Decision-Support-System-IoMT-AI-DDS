...
if __name__ == '__main__':
    ...
    data_dir = r'C:\Users\Usuario\Desktop\ECG_Training_Second_Dataset\Second_Dataset_Training'
    ...
    # --- 6. CHECKPOINTING & EARLY STOPPING VARIABLES ---
    best_val_acc = 0.0
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val':
                if epoch_acc > best_val_acc:
                    ...
                    torch.save(model.state_dict(), 'ecg_mobilenet_children_BEST.pth')
    ...
    print("Best model saved to ecg_mobilenet_BEST.pth")
